...
export default function ResultCard({ result, onStartOver }) {
  return (
    <div className="animate-riseIn text-center">
      <p className="text-sm font-semibold uppercase tracking-wide text-copper-600">Your estimate</p>
      ...
      <p className="mx-auto mt-3 max-w-md text-sm text-slate-600">
        This range reflects current material costs, your roof's pitch and layers, and a standard
        permit fee. A Northline estimator will follow up to confirm exact pricing.
      </p>
